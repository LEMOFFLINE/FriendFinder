...
async function GET(request) {
    try {
        ...
        const currentUserInterests = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$database$2f$pg$2d$client$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])(`SELECT COALESCE(hobbies, ARRAY[]::text[]) as hobbies FROM user_interests WHERE user_id = $1`, [
            currentUserId
        ]);
    ...
    `;
        const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$database$2f$pg$2d$client$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])(sql, [
            currentUserId,
            myInterests
        ]);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__f5991bc1._.js.map