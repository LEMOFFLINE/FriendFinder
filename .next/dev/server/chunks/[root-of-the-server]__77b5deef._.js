...
"[project]/app/api/users/[userId]/interests/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function PUT(request, { params }) {
    try {
        ...
        await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$database$2f$postgres$2d$client$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["postgresDb"].setUserInterests(userId, interests);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            success: true,
            interests
        });
...
async function GET(request, { params }) {
    try {
        const { userId } = await params;
        const interests = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$database$2f$postgres$2d$client$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["postgresDb"].getUserInterests(userId);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            interests
        });
    } catch (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__77b5deef._.js.map